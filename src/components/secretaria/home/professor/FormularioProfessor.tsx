          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  {modo === 'edicao' ? (
                    <option value="">Manter atual ({professor?.sexo === 'M' ? 'Masculino' : 'Feminino'})</option>
                  ) : (
                ...
                {modo === 'edicao' && (
                  <span className="text-xs text-gray-500 mt-1 block">Atual: {professor?.sexo === 'M' ? 'Masculino' : 'Feminino'}</span>
                )}
              </div>
